type CopyIconProps = React.ComponentPropsWithoutRef<"svg"> & {
  className?: string;
};

export default function CopyIcon({ className, ...props }: CopyIconProps) {
  return (
    <svg viewBox="0 0 32 32" className={className} xmlns="http://www.w3.org/2000/svg" aria-label="Copy Icon" {...props}>
